angular.module('incrowd')
  .controller('Polls', function ($http, $stateParams, $location, djResource, BACKEND_SERVER) {
    "use strict";

    var Polls = {}, deferred = $q.defer();

    Polls.resource = djResource(BACKEND_SERVER + 'polls\/:pollStub\/submissions\/:submissionId', {
      postId: '@stub',
      page: '@id'
    });

    Polls.submit_submission = function (poll, submission) {
      console.log("submitting poll", poll, submission);
